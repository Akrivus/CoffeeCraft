...
import mod.coffeecraft.block.CoffeeBagBlock;
import mod.coffeecraft.block.CoffeeCauldronBlock;
import mod.coffeecraft.block.CoffeePlantBlock;
import mod.coffeecraft.block.CoffeeSaplingBlock;
import mod.coffeecraft.block.CoffeeSeedlingBlock;
import mod.coffeecraft.block.DryingMatBlock;
import mod.coffeecraft.block.EspressoMachineBlock;
import mod.coffeecraft.block.GooseneckKettleBlock;
import mod.coffeecraft.block.GrinderBlock;
import mod.coffeecraft.block.RoasterBlock;
import mod.coffeecraft.effect.CaffeinatedEffect;
import mod.coffeecraft.effect.PurrfectEffect;
import mod.coffeecraft.effect.WithdrawalEffect;
import mod.coffeecraft.items.AbstractCoffeeItem;
import mod.coffeecraft.items.CoffeeCherriesItem;
import mod.coffeecraft.items.CoffeeSeedsItem;
import mod.coffeecraft.tileentity.CoffeeBagTileEntity;
import mod.coffeecraft.tileentity.CoffeeCauldronTileEntity;
import mod.coffeecraft.tileentity.DryingMatTileEntity;
import mod.coffeecraft.tileentity.EspressoMachineTileEntity;
import mod.coffeecraft.tileentity.GooseneckKettleTileEntity;
import mod.coffeecraft.tileentity.GrinderTileEntity;
import mod.coffeecraft.tileentity.RoasterTileEntity;
